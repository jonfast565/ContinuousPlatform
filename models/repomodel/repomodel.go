...
func NewRepositoryFileMetadata(repo string, branch string, name string) RepositoryFileMetadata {
	return RepositoryFileMetadata{Repo: repo, Branch: branch, Name: name}
}
